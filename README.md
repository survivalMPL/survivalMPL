...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/survivalMPL)](https://CRAN.R-project.org/package=survivalMPL)
[![Downloads](https://cranlogs.r-pkg.org/badges/survivalMPL)](https://CRAN.R-project.org/package=survivalMPL)
<!-- badges: end -->
