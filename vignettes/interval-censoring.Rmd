...
plot(mela_fit, ask = FALSE, which = 2:4, cex.main = 0.8)
```
...
- **Left Censoring** covers the boundary case of interval censoring, where the
  lower endpoint is unknown, and shows that recording an observation as
  $(0, t_R]$ and as left censored at $t_R$ give the same fit.
